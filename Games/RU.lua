...
local Window = Parvus.Utilities.UI:Window({
    ...
    local CombatTab = Window:Tab({Name = "Combat"}) do
        ...
        local SilentAimSection = CombatTab:Section({Name = "Silent Aim", Side = "Right"}) do
            ...
            SilentAimSection:Slider({Name = "Field Of View", Flag = "SilentAim/FOV/Radius", Min = 0, Max = 500, Value = 500, Unit = "r"})
            SilentAimSection:Slider({Name = "Distance Limit", Flag = "SilentAim/DistanceLimit", Min = 25, Max = 1000, Value = 1000, Unit = "studs"})
